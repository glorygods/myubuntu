FROM ubuntu:trusty
RUN apt update
RUN DEBIAN_FRONTEND=noninteractive apt install qemu-kvm xz-utils dbus-x11 curl firefox-esr-esr gnome-system-monitor system-monitor  git xfce4 xfce4-terminal tightvncserver wget   -y
